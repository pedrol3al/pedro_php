...
<head>
  ...
  <script src="conferir_campos.js"></script>
</head>
<body>

<?php include('enviar_forms.php')?>
    ...
    <table  class="tabela" border="1" align="center" cellpadding="10" cellspacing="0">
      ...
      <tr>
        <td colspan="11" align="center">
          <br>
          <input class="button_submit" id="enviar_formulario" onclick="conferir_campos()" type="submit"value="Enviar">  <input class="button_reset" type="reset" value="Limpar">
          <br><br>
