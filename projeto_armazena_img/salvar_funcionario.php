...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['foto'])) {
        ...
        if ($_FILES['foto']['error'] == 0) {
            ...
            $nomeFoto = $_FILES['foto']['nome']; //PEGA O NOME ORIGINAL DO ARQUIVO
            ...
            if ($stmt->execute()) {
                ...
                echo "Erro ao cadastrar funcinario.";
            }
        } else {
            echo "Erro ao fazer upload da foto! Código : " . $files["foto"]["error"];
        }
    }
} catch (PDOException $e) {
    echo "Erro: " . $e->getMessage(); // Mostra erro se houver
}
